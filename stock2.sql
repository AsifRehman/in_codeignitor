...
(1, 'Webrider', '13', '0', 'Madrid', '758676851', 'sri lanka', 'hello everyone one', 'PKR');
...
(4, 'BILPR-239D', 'Shafraz', '', '0778650336', '1526279725', '600300.00', '13', '78039.00', '10', '60030.00', '738369.00', '', 1, 1),
(5, 'BILPR-0266', 'Chris', 'California', '05552242', '1526358119', '761700.00', '13', '99021.00', '10', '76170.00', '936891.00', '', 2, 1),
(6, 'BILPR-0E48', 'Asif Rehman', 'st#.3 ali ', '03339933886', '1574153963', '450300.00', '13', '58539.00', '10', '45030.00', '553869.00', '', 2, 1),
(7, 'BILPR-9D43', 'ali raza', '', '03339933886', '1574155805', '150060.20', '13', '19507.83', '0', '0', '169568.03', '', 1, 1);
...
(9, 4, 8, '4', '150000', '600000.00'),
(10, 4, 12, '1', '300', '300.00'),
(11, 6, 12, '1', '300', '300.00'),
(12, 6, 8, '2', '150000', '300000.00'),
(13, 6, 8, '1', '150000', '150000.00'),
(16, 7, 10, '1', '150000', '150000.00'),
(17, 7, 13, '2', '30.10', '60.20');

-- --------------------------------------------------------

--
-- Table structure for table `partycategs`
--

CREATE TABLE `partycategs` (
  `id` int(11) NOT NULL,
  `PartyCateg` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `active` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `partycategs`
--

INSERT INTO `partycategs` (`id`, `PartyCateg`, `active`) VALUES
(1, 'ASSETTS', 1),
(2, 'LIABILITIES', 1),
(3, 'REVENUES', 1),
(4, 'EXPENSES', 1);
...
(8, 'computer', '', '150000', '41', 'assets/images/product_image/5af844384c067.jpg', '<p>dsadsad<br></p>', 'null', 'null', '[\"5\"]', 5, 1),
(10, 'Mac', '', '150000', '38', 'assets/images/product_image/5afa5fe395f9d.jpg', '<p>sample <br></p>', '[\"17\",\"20\"]', '[\"15\"]', '[\"7\"]', 5, 1),
(11, 'Rubuke', '', '900', '37', 'assets/images/product_image/5afa6026d808e.jpg', '<p>sample<br></p>', '[\"17\",\"21\"]', '[\"15\"]', '[\"7\"]', 5, 1),
(12, 'test1', '', '300', '118', '<p>You did not select a file to upload.</p>', '', '[\"17\",\"20\",\"21\",\"22\"]', '[\"16\"]', '[\"7\",\"8\"]', 5, 1),
(13, 'Blue R', '', '30.10', '8', 'assets/images/product_image/5dd3b5bb4538f.jpg', '', '[\"17\",\"21\"]', '[\"16\"]', '[\"8\"]', 5, 1);
...
--
-- Indexes for table `partycategs`
--
ALTER TABLE `partycategs`
  ADD PRIMARY KEY (`id`);
