...
class Controller_PartyCategs extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Party Category';

		$this->load->model('model_partycategs');
	}
	...
	*/
	public function index()
	{
		...
		$this->render_template('partycategs/index', $this->data);	
	}	
	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$create = $this->model_partycategs->create($data);
        	if($create == true) {
	...
	public function update($id)
	{
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	...
	        	$update = $this->model_partycategs->update($data, $id);
	        	if($update == true) {
	        		$response['success'] = true;
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($partycategoryid) {
			$delete = $this->model_partycategs->remove($partycategoryid);
			if($delete == true) {
				$response['success'] = true;
