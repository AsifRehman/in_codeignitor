...
class Controller_PartyTypes extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Party Types';

		$this->load->model('model_partytypes');
	}
	...
	*/
	public function index()
	{
		...
		$this->render_template('partytypes/index', $this->data);	
	}	
	...
	*/
	public function fetchPartyTypesDataById($id) 
	{
		if($id) {
			$data = $this->model_partytypes->getPartyTypesData($id);
	...
	*/
	public function fetchPartyTypesData()
	{
		$result = array('data' => array());

		$data = $this->model_partytypes->getPartyTypesData();
	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$create = $this->model_partytypes->create($data);
        	if($create == true) {
	...
	public function update($id)
	{
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	...
	        	$update = $this->model_partytypes->update($data, $id);
	        	if($update == true) {
	        		$response['success'] = true;
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($id) {
			$delete = $this->model_partytypes->remove($id);
			if($delete == true) {
				$response['success'] = true;
